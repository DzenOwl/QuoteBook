...
const FavoriteQuoteBooks = () => {
  useEffect(() => {
    // update the document title
    document.title = `Favorite Quote Books — ${APP_NAME}`;
  });

  const { loading, error, data } = useQuery(GET_MY_FAVORITE_QUOTEBOOKS);
...
export default FavoriteQuoteBooks;
